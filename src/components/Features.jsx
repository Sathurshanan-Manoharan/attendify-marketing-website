...
const Features = () => {
  return (
    <section className="bg-white font-Raleway">
      ...
      <div className="flex flex-wrap justify-center">
        <div
          className="max-w-xs mx-2 my-4 bg-white shadow-xl rounded-xl overflow-hidden transform hover:translate-y-[-20px] transition duration-250"
        ...
        >
          ...
          <div className="px-6 py-4">
            <h6 className="text-s font-bold text-center ">
        ...
        >
          ...
          />
          <div className="px-6 py-4">
            <h3 className="text-s font-bold mb-2 text-center">
